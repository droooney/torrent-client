/*
  ...
  - The values [AddScenarioStepSetTurnOnDevice,AddScenarioStepSetTurnOffDevice] on the enum `telegram_user_state` will be removed. If these variants are still used in the database, this will fail.
