import {
  InlineKeyboardButton as LibInlineKeyboardButton,
  InlineKeyboardButtons as LibInlineKeyboardButtons,
} from '@tg-sensei/bot';
import { z } from 'zod';
...
export type InlineKeyboardButtons = LibInlineKeyboardButtons<CallbackData>;
